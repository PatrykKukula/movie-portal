...
//            "FROM Movie m LEFT JOIN m.actors a LEFT JOIN m.director d LEFT JOIN m.movieRates mr WHERE m.movieId = :movieId GROUP BY m")
//    Optional<Tuple> findByIdWithActorsAndMovieRates(@Param(value = "movieId") Long movieId);
    ...
    Optional<Movie> findWithActorsAndDirectorsById(@Param( value = "movieId") Long movieId);
