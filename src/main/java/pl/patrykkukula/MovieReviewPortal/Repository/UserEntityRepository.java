...
public interface UserEntityRepository extends JpaRepository<UserEntity, Long> {
    ...
    @Query("SELECT u FROM UserEntity u LEFT JOIN FETCH u.comments WHERE u.userId = :userId")
