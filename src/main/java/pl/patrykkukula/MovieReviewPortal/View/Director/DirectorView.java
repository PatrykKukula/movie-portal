...
public class DirectorView extends VerticalLayout {
    ...
    public DirectorView(DirectorServiceImpl directorService) {
        ...
        addDirector.setPrefixComponent(VaadinIcon.PLUS.create());
        addDirector.addClickListener(e -> UI.getCurrent().navigate(AddDirectorView.class));
        ...
        add(title, addDirector, searchField, grid);
